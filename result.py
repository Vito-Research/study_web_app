...
def results(date, data):
    ...
    analyze(data.heart_rate, "Heart Rate")
    analyze(data.heart_rate_variability, "Heart Rate Variability Rate")
    analyze(data.breathing_rate, "Breathing Rate")
    analyze(data.oxygen_saturation, "Blood Oxygen %")